...
`Настройки \\(Settings\\) \\-\\> Конфиденциальность \\(Privacy and Security\\) \\-\\> Пересылка сообщений \\(Forwarded Messages\\) \\-\\> Всегда разрешать \\(Always allow\\)` и добавить бота в список исключений\\.
